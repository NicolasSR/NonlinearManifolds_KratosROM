...
if __name__ == "__main__":
    ...
    def get_multiple_params():
        ...
        param2 = random_samples_from_interval(-30,30,number_of_params_2)
        mu = []
    ...
    project_parameters_name = "datasets_rubber_hyperelastic_cantilever_big_range/ProjectParameters_tf.json"
