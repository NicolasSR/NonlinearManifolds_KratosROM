...
class FISTA_L1_Strategy_KerasModel(keras.Model):

    def __init__(self, prepost_processor, kratos_simulation, strategy_config, *args, **kwargs):
        super(FISTA_L1_Strategy_KerasModel,self).__init__(*args,**kwargs)
    ...
    def fit(self, input_data, target_data, epochs=None, shuffle=None, batch_size=None, validation_data=None, validation_batch_size=None, callbacks=None):
