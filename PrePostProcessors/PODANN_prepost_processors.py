...
class SVD_White_NoStand_PODANN_PrePostProcessor(Base_PODANN_PrePostProcessor):
    ...
    def configure_processor(self, S, svd_inf_size, svd_sup_size):
        ...
        S_recons_aux2=self.preprocess_input_data(S)
        S_recons = self.postprocess_output_data(S_recons_aux1, S_recons_aux2)
