...
class NN_Trainer():
    ...
    def execute_training(self):
        ...
        input_data = input_data[gap_sample_ids_train]
        for i in range(len(target_data)):
            target_data[i] = target_data[i][gap_sample_ids_train]
        val_input = val_input[gap_sample_ids_val]
        for i in range(len(val_target)):
            val_target[i] = val_target[i][gap_sample_ids_val]
        ...
        for i in range(len(val_target)):
            print('Shape val_target [', i, ']: ', val_target[i].shape)
